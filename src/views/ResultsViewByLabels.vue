  ...
  <div>
    ...
    <div>
      ...
      <div class="container pt-5 pb-2">
        <h3 class='text-center py-2'>Resultados para: <i>{{ decodeURI(this.$route.params.tag) }}</i></h3>
...
export default {
  ...
  created(){
    this.getProductsByLabels(this.$route.params.tag);
  },
  computed:{
    ...mapState('blogger', ['loader'])
  },
  methods: {
    ...mapActions('blogger', ['getProductsByLabels'])
  }
